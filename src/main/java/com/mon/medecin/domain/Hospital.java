...
public class Hospital implements Serializable {
    ...
    @JsonIgnore
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    private Set<Service> writers = new HashSet<>();
    ...
    public Set<Service> getWriters() {
        return writers;
    }

    public Hospital writers(Set<Service> services) {
        this.writers = services;
        return this;
    }

    public Hospital addWriter(Service service) {
        this.writers.add(service);
        service.setHospital(this);
        return this;
    }

    public Hospital removeWriter(Service service) {
        this.writers.remove(service);
        service.setHospital(null);
        return this;
    }

    public void setWriters(Set<Service> services) {
        this.writers = services;
    }
