(function() {
    ...
    SubCategoryDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'DataUtils', 'entity', 'SubCategory', 'Category', 'Hospital'];

    function SubCategoryDialogController ($timeout, $scope, $stateParams, $uibModalInstance, DataUtils, entity, SubCategory, Category, Hospital) {
        var vm = this;
        ...
        function onSaveSuccess (result) {
            $scope.$emit('betaMedecinApp:subCategoryUpdate', result);
